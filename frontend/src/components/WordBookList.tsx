  ...
  if (wordbooks.length === 0) {
    return (
      <div className="text-center py-8">
        <LuBook className="mx-auto w-16 h-16 text-gray-400 mb-4" />
        <h3 className="text-lg font-medium text-gray-900 mb-2">
          単語帳が見つかりません
        </h3>
        <p className="text-gray-600">条件に一致する単語帳がありません</p>
      </div>
    )
  }
          ...
          <div className="p-6">
            ...
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="flex items-center gap-1 ml-2">
                {wordbook.is_public ? (
                  <LuGlobe className="w-4 h-4 text-green-600" title="公開" />
                ) : (
                  <LuLock className="w-4 h-4 text-gray-500" title="非公開" />
                )}
              </div>
            </div>
