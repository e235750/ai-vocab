...
interface EditFormCoreProps {
  cardData: Card
  onSubmit: (updatedCard: NewCard) => void
  onCancel: () => void
  submitButtonText?: string
  className?: string
}

export default function EditFormCore({
  cardData,
  onSubmit,
  onCancel,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updatedCard: NewCard = {
      ...
      phonetics: cardData.phonetics, // 元の発音記号をそのまま保持
      wordbook_id: cardData.wordbook_id,
    }
